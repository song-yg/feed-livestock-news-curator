...
SITES = {
    # 일시 비활성화: 재활성화하려면 아래 주석만 풀면 됨(다른 코드 변경 불필요).
...
def _parse_published_time(raw: str) -> datetime:
    ...
    #    WATTAgNet/Feed Strategy 실측 둘 다에서 안 쓰였음 (2026-07-14/07-15 확인)
    # - 혹시 모를 형식 차이 대비 안전망으로만 유지
    try:
